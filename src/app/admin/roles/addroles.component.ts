...
@Component({
  ...
  template: '<jw-modal id="add-tax-table">' +
    ...
    '            <i class="icon-down-arrow com-arw"></i>Add New <span>Role</span>\n' +
    '        </h3>\n' +
    '        <!-- common headline end -->\n' +
    '        <form [formGroup]="addrolesForm" (ngSubmit)="createroles(addrolesForm.value)"  class="popup-scrll">\n' +
    '\n' +
    '            <div class="filBox">\n' +
    '                <!-- start -->\n' +
    ...
    '                            </div>\n' +
    // '                            <div class="form-group">\n' +
    // '                                <select id="role-multi1" class="select-field-2 form-field" name="multiSelect[]"\n' +
    // '                                    multiple="multiple">\n' +
    ...
    // '                                </select>\n' +
    // '                                <p class="form-label sel-blk">Rights</p>\n' +
    // '                            </div>\n' +
    '                            <!-- end -->\n' +
    '                        </div>\n' +
    ...
    '                            </div>\n' +
    // '                            <div class="form-group">\n' +
    // '                                <select id="role-multi2" class="select-field-2 form-field" name="multiSelect[]"\n' +
    // '                                    multiple="multiple">\n' +
    // '                                    <option value="1">Administrator</option>\n' +
    // '                                    <option value="2">Manager</option>\n' +
    // '                                    <option value="3">Employee</option>\n' +
