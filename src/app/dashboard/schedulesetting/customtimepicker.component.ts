...
@Component({
  ...
  template: '<form [formGroup]="customTimePicker">'+
    ...
    '            <select class="select-field form-field" [(ngModel)]="schedule.Hour" (change)="datechange(hour)" formControlName="StartTimeHour">\n' +
    ...
    '          <!-- start -->\n' +
    '          <div class="form-group">\n' +
    '            <select class="select-field form-field" formControlName="StartTimeMinute" [(ngModel)]="schedule.minute" (change)="datechange(minute)">\n' +
    ...
    '            <input type="radio" id="{{addchildAMMessage}}" value="AM" [(ngModel)]="schedule.StartTimeMeridian" formControlName="StartTimeMeridian" (click)="datechange(\'AM\')">\n' +
    '            <label for="{{addchildAMMessage}}">AM</label>\n' +
    '          </div>\n' +
    '          <!-- end -->\n' +
    '          <!-- start -->\n' +
    '          <div class="radio-box radio-box-2">\n' +
    '            <input type="radio" id="{{addchildPMMessage}}" value="PM" [(ngModel)]="schedule.EndTimeMeridian" formControlName="StartTimeMeridian" (click)="datechange(\'PM\')">\n' +
    ...
    '          <!-- start -->\n' +
    '          <div class="form-group">\n' +
    '            <select class="select-field form-field" [(ngModel)]="schedule.EndTimeHour" (change)="datechange(hour1)" formControlName="EndTimeHour" required="">\n' +
    '              <option value="">HH</option> '+
    ...
    '          <!-- start -->\n' +
    '          <div class="form-group">\n' +
    '            <select class="select-field form-field" formControlName="EndTimeMinute" [(ngModel)]="schedule.minute1" (change)="datechange(minute1)" required="">\n' +
    '              <option value="">MM</option> '+
    ...
    '          <!-- start -->\n' +
    '          <div class="radio-box radio-box-2">\n' +
    '            <input type="radio" id="{{addEndAMMessage}}" value="AM" [(ngModel)]="schedule.StartTimeMeridian" (click)="datechange1(\'AM\')" formControlName="EndTimeMeridian" >\n' +
    '            <label for="{{addEndAMMessage}}">AM</label>\n' +
    '          </div>\n' +
    '          <!-- end -->\n' +
    '          <!-- start -->\n' +
    '          <div class="radio-box radio-box-2">\n' +
    '            <input type="radio" id="{{addEndPMMessage}}" value="PM" [(ngModel)]="schedule.EndTimeMeridian" (click)="datechange1(\'PM\')" formControlName="EndTimeMeridian" >\n' +
